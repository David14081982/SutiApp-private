...
(function () {
  ...
  const store={
    ...
    blank:(programKey)=>({id:null,program_key:programKey,scope:'fin',scopeId:programKey,nombre:'',desc:'',category_raw:'',precio:null,cotiza:true,activo:true,orden:store.byProgram(programKey).length+1,record_origin:'ADMIN_PROGRAM_CATALOG',requestMode:'supabase',source_sheet:null,source_row_ordinal:null,bootstrapProgram:programKey==='cirugias'&&store.byProgram(programKey).length===0?'cirugias':null,imagenAssets:[],imagenes:[]}),
