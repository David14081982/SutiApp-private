...
(function(){
  ...
  function RequestsModule({app,onBack,header,initialAffiliateId}){
    ...
    return desktop?h(DesktopRequests,{app,onBack,header,rows:scopedRows,phase,error,reload:load}):h(MobileRequests,{app,onBack,header,rows:scopedRows,phase,error,load,busy:{value:busyValue,set:setBusyValue}});
  }
