        ...
        h('main', { className: 'su-inv-body' },
          h('section', { className: 'su-inv-card', 'aria-labelledby': 'investment-calculator-title' },
            ...
            editing
              ...
              : h('button', { type: 'button', className: 'su-inv-amount', onClick: () => { setDraft(String(amount)); setEditing(true); }, 'aria-label': 'Editar monto', 'data-investment-amount': String(amount) }, money(amount), h('span', { className: 'su-inv-amount-pen' }, icon('pencil', 19))),
