...
| 5 | Descargas y normas | Tu sindicato · Formatos/Normas; Mis documentos no equivale | `Descargas2`, `Normas y Reglamentos` | 8 filas fuente trazables; 7 documentos únicos visibles por ADR-099 | No | SUPABASE_ACTIVE | LOW | HIGH |
...
| 5 | Descargas/normas | `InstitutionalDocumentsRepository` | `Descargas2` y `Normas y Reglamentos` | lista/archivo | importador H-007; corte ADR-099 | metadata/asset; URL Google sólo procedencia privada | none | `institutional_documents → app_assets → documents` | `public.institutional_documents` | SUPABASE_ACTIVE | 8 filas fuente; 7 assets únicos visibles; duplicado `Descargas2!15/17` preservado despublicado |
