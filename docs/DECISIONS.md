...
- **Decisión visual:** los cinco importes de `StepSimulatorV2` usan carretes verticales de glifos. Cada transición recorre seis vueltas y todos los carretes terminan en 1 segundo como máximo; no se añade tiempo por columna. Durante una espera más larga, los glifos de carga permanecen visibles y estáticos al completar ese único ciclo hasta recibir el resultado; nunca existe un intervalo intermedio sin dígitos.
