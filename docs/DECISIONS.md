...
- **Estado y writers:** monto/plazo viven únicamente en estado React efímero. Se prohíben `localStorage`, caché, mock como autoridad, Google, Supabase, Edge, RPC, registro productivo y transferencia. ~~El CTA muestra una confirmación informativa interna~~ — revisado por el propietario el 2026-09-17: el CTA abre WhatsApp con el número autorizado `52 662 342 3660` y el mensaje `Quiero información para invertir <monto>`; sigue sin crear inversión, sin escribir autoridad y sin leer legacy. La prohibición de WhatsApp queda levantada sólo para este contacto informativo.
...
### ADR-111 — Convenios unificados y acreditación empresarial presencial

- **Autorización:** H-COMPANIES-CONVENIOS-EDUCATION-UNIFICATION-001 y aclaración expresa del propietario: crear tipos de plan, precios y límites; Admin acredita pagos presenciales y el plan habilita propuestas de pop-up en Inicio.
- **Catálogo inicial autorizado (MXN):** Esencial 299/mes, 3588/año, 5 productos; Impulso 599/mes, 7188/año, 15 productos y pop-ups; Destacado 999/mes, 11988/año, 50 productos, pop-ups e historial mensual. Anual equivale a doce mensualidades. Todos incluyen ficha, imágenes, promociones sujetas a aprobación y operación comercial existente. Se pueden administrar desde Planes. Esto sustituye únicamente la ausencia de términos comerciales de ADR-033; no inventa contrataciones.
- **Pago:** accredit_company_plan requiere company_portal.write, confirmación de pago recibido y referencia; calcula importe, vigencia y actor en backend. Opcionalmente asigna una cuenta Auth existente y verificada. Cero cobro electrónico, cero suscripciones/membresías creadas al instalar planes.
- **Autoridades:** companies y sus beneficios/productos para empresas y convenios; educational_resources para Educación. list_public_convenios proyecta UUID/tipo originales, categorías backend, audiencias y publicación. Instituciones no se copian a companies. Tutoriales permanece separado.
- **Permisos:** empresa activa sólo su tenant; responsable Convenios administra ficha y productos opcionales gratuitos, sin otorgar membresías; Educación conserva su frontera con Tutoriales. Aprobación/publicación de promociones exige permiso backend. Propuestas de pop-up mantienen aprobación administrativa y posterior publicación de borrador conforme ADR-040.
- **Datos:** public_details extiende la entidad original; assets siguen en app_assets/Storage. Favoritos educativos son vínculos propios por Auth, no copias. Solicitudes comerciales se leen por RPC tenant con proyección mínima; no se reabren grants de program_requests ni se alteran writers/legacy financieros.
- **Evidencia:** docs/qa/H-COMPANIES-CONVENIOS-EDUCATION-UNIFICATION-001.md; migraciones 20260908000900 y 20260909000100, SQL transaccional/recovery, Auth, browser y regresión global.
...
Release de H-USER-TEXT-SIZE-SMALL-001, 2026-09-11: al integrar los 11 commits
