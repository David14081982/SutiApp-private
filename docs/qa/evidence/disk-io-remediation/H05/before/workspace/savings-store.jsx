...
(function () {
  ...
  let selfGeneration = 0, adminGeneration = 0, identity = '', authSubscribed = false;
  ...
  const store = {
    ...
    clearSelf: () => { selfGeneration++; selfPromise = null; self = null; selfPhase = 'idle'; selfError = null; emit(); },
