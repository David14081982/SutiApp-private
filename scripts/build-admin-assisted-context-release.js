...
const selected=['admin-repository.js','admin-cutover-store.jsx','app.jsx'];
...
assert.equal(found.length,3);new vm.Script(next);
...
fs.writeFileSync(path.join(root,'docs/qa/evidence/admin-assisted-context-20260915/release-build.json'),JSON.stringify(result,null,2));console.log(JSON.stringify(result));
