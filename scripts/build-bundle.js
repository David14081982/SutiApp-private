...
const files = [
  ...
  'union-screen-registry.js', 'data.jsx', 'visual-repositories.js', 'visual-content.js', 'content-repositories.js', 'content-state.js', 'admin-repository.js', 'admin-cutover-repository.js', 'data-export-repository.js', 'admin-affiliates-repository.js', 'program-request-repository.js', 'admin-finance-queue-repository.js', 'private-resource-demand.js', 'document-workflow-repository.js', 'bank-account-repository.js', 'program-terms-repository.js', 'credential-qr-repository.js', 'marketplace-repository.js', 'program-catalog-repository.js', 'popup-proposal-repository.js', 'payroll-declaration-repository.js', 'savings-repository.js', 'investment-copy-repository.js',
  ...
  'funds-store.jsx', 'admin-popup-editor.jsx', 'savings-review-repository.js', 'savings-access-admin.jsx', 'savings-recorded-history.jsx', 'savings-withdrawal-list.jsx', 'savings-review-admin.jsx', 'savings-operations-admin.jsx', 'savings-retirement-admin.jsx', 'savings-yield-admin.jsx',
  'section-responsibility.jsx', 'screens-admin-roles.jsx', 'screens-admin-content.jsx', 'screens-admin-news.jsx',
  'screens-admin-convenios.jsx', 'screens-admin-sindicato.jsx', 'screens-admin-finanzas.jsx', 'screens-admin-fondos.jsx', 'screens-admin-fincat.jsx', 'screens-admin-flujos.jsx', 'screens-admin-inversion.jsx', 'screens-admin-documents.jsx',
