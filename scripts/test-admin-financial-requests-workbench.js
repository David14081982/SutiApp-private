...
assert.ok(html.includes('app/bundle.js?v=162'),'HTML cachebuster missing');
assert.ok(serviceWorker.includes("sutiapp-v106")&&serviceWorker.includes('app/bundle.js?v=162'),'service worker cache cutover missing');
