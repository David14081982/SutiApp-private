...
assert.ok(html.includes('app/bundle.js?v=166'),'HTML cachebuster missing');
assert.ok(serviceWorker.includes("sutiapp-v110")&&serviceWorker.includes('app/bundle.js?v=166'),'service worker cache cutover missing');
