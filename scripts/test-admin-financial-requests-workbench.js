...
assert.match(workbench,/useFinancialDocumentPreviews\(detail, detailPhase === 'loaded'/);
assert.match(screen,/DocumentWorkflowRepository\.adminPreview/);
assert.match(workbench,/mime\.startsWith\('image\/'\)/);
assert.match(workbench,/mime\s*===\s*['"]application\/pdf['"]/);
