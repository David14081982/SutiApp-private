...
assert.ok(html.includes('app/bundle.js?v=156'),'HTML cachebuster missing');
assert.ok(serviceWorker.includes("sutiapp-v100")&&serviceWorker.includes('app/bundle.js?v=156'),'service worker cache cutover missing');
