...
assert.ok(html.includes('app/bundle.js?v=179'),'HTML cachebuster missing');
assert.ok(serviceWorker.includes("sutiapp-v123")&&serviceWorker.includes('app/bundle.js?v=179'),'service worker cache cutover missing');
