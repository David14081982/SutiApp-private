...
assert.ok(html.includes('app/bundle.js?v=161'),'HTML cachebuster missing');
assert.ok(serviceWorker.includes("sutiapp-v105")&&serviceWorker.includes('app/bundle.js?v=161'),'service worker cache cutover missing');
