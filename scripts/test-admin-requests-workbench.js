...
assert.ok(html.includes('app/bundle.js?v=160'),'HTML cachebuster missing');
assert.ok(serviceWorker.includes("sutiapp-v104")&&serviceWorker.includes('app/bundle.js?v=160'),'service worker cache cutover missing');
