...
assert.ok(html.includes('app/bundle.js?v=153'),'HTML cachebuster missing');
assert.ok(serviceWorker.includes("sutiapp-v97")&&serviceWorker.includes('app/bundle.js?v=153'),'service worker cache cutover missing');
