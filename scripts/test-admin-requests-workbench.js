...
assert.ok(html.includes('app/bundle.js?v=154'),'HTML cachebuster missing');
assert.ok(serviceWorker.includes("sutiapp-v98")&&serviceWorker.includes('app/bundle.js?v=154'),'service worker cache cutover missing');
