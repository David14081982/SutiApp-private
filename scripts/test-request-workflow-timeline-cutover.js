...
assert(html.includes('bundle.js?v=179')&&html.includes('financial-legacy-repository.js?v=9')&&sw.includes("sutiapp-v123")&&sw.includes('bundle.js?v=179'),'cache cutover missing');
