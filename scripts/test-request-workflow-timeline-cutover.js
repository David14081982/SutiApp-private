...
assert(html.includes('bundle.js?v=178')&&html.includes('financial-legacy-repository.js?v=9')&&sw.includes("sutiapp-v122")&&sw.includes('bundle.js?v=178'),'cache cutover missing');
