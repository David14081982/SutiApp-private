...
require('./verification-helpers').assertPwaVersionSync(process.cwd());assert(html.includes('financial-legacy-repository.js?v=10'),'financial repository cache contract missing');
