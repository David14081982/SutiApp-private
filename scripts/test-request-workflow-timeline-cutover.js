...
assert(html.includes('bundle.js?v=177')&&html.includes('financial-legacy-repository.js?v=9')&&sw.includes("sutiapp-v121")&&sw.includes('bundle.js?v=177'),'cache cutover missing');
