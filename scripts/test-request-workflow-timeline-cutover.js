...
assert(html.includes('bundle.js?v=176')&&html.includes('financial-legacy-repository.js?v=9')&&sw.includes("sutiapp-v120")&&sw.includes('bundle.js?v=176'),'cache cutover missing');
