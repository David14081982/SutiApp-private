...
assert(html.includes('bundle.js?v=171')&&html.includes('financial-legacy-repository.js?v=8')&&sw.includes("sutiapp-v115")&&sw.includes('bundle.js?v=171'),'cache cutover missing');
