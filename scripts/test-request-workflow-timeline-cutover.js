...
assert(html.includes('bundle.js?v=175')&&html.includes('financial-legacy-repository.js?v=9')&&sw.includes("sutiapp-v119")&&sw.includes('bundle.js?v=175'),'cache cutover missing');
