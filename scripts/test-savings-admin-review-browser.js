...
async function main(){
 ...
 try{
  ...
  await page.getByLabel('Saldo del archivo original',{exact:true}).fill('600');
  ...
  await page.getByLabel('Grupo de campos').selectOption('dates');await page.getByLabel('2026-01-15 · Descuento registrado',{exact:true}).fill('0');
  ...
  await page.getByRole('button',{name:'Volver a editar',exact:true}).click();await page.getByLabel('2026-01-15 · Descuento registrado',{exact:true}).fill('');
