...
-- Function-only correction: membership_offerings.concept is the canonical field.
...
as $$ begin
  ...
  return query
    select 'PROGRAM'::text,'prestamo'::text,'Suti Prestamo'::text,null::text,null::text,true
