...
$guard$;
create index if not exists savings_legacy_evidence_participant_type_source_idx on public.savings_legacy_evidence (participant_id,record_type,source_sheet,source_row DESC);
